$(function() {
    ...
    $('#add_member').click(function() {
        ...
        var tr = $('<tr>')
        $('input[name="Household_no"]').val('')
        tr.addClass('py-1 px-2');
        tr.attr('data-id', '');
        tr.append('<td contenteditable name="Head_of_the_family"></td>')
        tr.append('<td contenteditable name="Year_of_Stay"></td>')
        tr.append('<td contenteditable name="Street"></td>')
        tr.append('<td contenteditable name="Date_Registered"></td>')
